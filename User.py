...
class Product:
        # initializer method
        def __init__(self, Product_id, Name, Description, Price, Amt_sold, Rating):
        ...
        def calculate_overall_sales(self):
            try:
                price = float(self.__Price)
                return price * self.__Amt_sold
            except ValueError:
                return 0  # Handle the case where the price is not a valid float